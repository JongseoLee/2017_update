...
public class TableRowData_BUR_BDIA extends TableRowData{
	private String name = "BUR BDIA";
	...
	public void setAllData(ArrayList<TableData_PLog> obj){
		...
		for(TableData_PLog o : obj){
			if(o.getSTAND().equals("F1")){
				this.setF1Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F2")){
				this.setF2Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F3")){
				this.setF3Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F4")){
				this.setF4Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F5")){
				this.setF5Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F6")){
				this.setF6Value(o.getBUR_BDIA());
			}else if(o.getSTAND().equals("F7")){
				this.setF7Value(o.getBUR_BDIA());
			}
		}
