...
public class TableRowData_P_CROSS extends TableRowData {
	private String name = "P-CROSS";
	...
	public void setAllData(ArrayList<TableData_PLog> obj){
		...
		for(TableData_PLog o : obj){
			if(o.getSTAND().equals("F1")){
				this.setF1Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F2")){
				this.setF2Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F3")){
				this.setF3Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F4")){
				this.setF4Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F5")){
				this.setF5Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F6")){
				this.setF6Value(o.getP_CROSS());
			}else if(o.getSTAND().equals("F7")){
				this.setF7Value(o.getP_CROSS());
			}
		}
